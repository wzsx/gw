...
<title>404-蜗牛财税</title>
<meta name="description" content="蜗牛财税404" />
<style type="text/css">
...
<script type="text/javascript" src="./skin/default/js/jquery-1.9.1.js"></script>
<!--解决 IE6 背景缓存-->
...
<body>
    ...
    <div id="wrapper">
        <a href="./"><img src="./skin/default/images/404_icon.png"></a>
        <div>
            <h1>唉呀!</h1>
            <p>你正在寻找的页面无法找到。<a style="color:#ff6600;" href="./">可能在这里！</a></p>
            <a class="link" href="./" onclick="history.go(-1)"><span id="sec">5</span> 秒后返回蜗牛财税官网</a>
			<br /><br /><br />
        </div>
    </div>
