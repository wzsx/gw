var LR_imgurl = 'https://pwt.zoosnet.net/';
var LR_js_pm = 'd';
var LR_websiteid = 'PWT33589766';
var LR_2e32f='309830C11D694264AE5DCB0A936B531D';if(typeof(LR_showfloat)=='undefined' || LR_showfloat!=1)var LR_showfloat = 1;
var LiveReceptionCode_isonline = 1;
LR_2e32f=LR_2e32f.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_siteid = '33589766';
var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_isMobile = 0;
var LR_ssl = 1;
var LR_lng = 'cn';
var LR_sysurl = 'https://pwt.zoosnet.net/';
LR_2e32f=((3+2).toString()+LR_2e32f+(3*2).toString());var LR_EMBB=LR_2e32f.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_helpsrc_on=unescape("http%3a%2f%2fpwt.zoosnet.net%2flr%2fimages%2fonline_cn3.gif");
	...
	var _lr_helpsrc_of=unescape("http%3a%2f%2fpwt.zoosnet.net%2flr%2fimages%2foffline_cn3.gif");
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&ELNO='+LR_EMBB;
...
function lr_useraa() {if (typeof (openZoosUrl) != 'function') {setTimeout('lr_useraa()', 100);return;} if(!LR_isMobile){LR_UserInviteDiv = '<div id="swtbox" style="width:492px; height:198px; background:url(http://www.wncsjt.com//skin/default/images/tanchuang.gif); overflow:hidden; position:relative"><div id="swtColse" style="z-index: 5; width: 102px; height: 33px; position: absolute; cursor: pointer; left: 199px; top: 142px;" onClick="{0};"></div><div id="swtColse" style="z-index: 9; width: 38px; height: 36px; position: absolute; cursor: pointer; left: 442px; top: 10px;" onClick="{1};return false;"></div><div id="swtColse" style="z-index: 9; width: 102px; height: 32px; position: absolute; cursor: pointer; left: 311px; top: 143px;" onClick="{1};return false;"></div></div>';}}lr_useraa();if(!LR_isMobile){var lr_xCenter = 246;var lr_yCenter = 99;}}
