...
var LR_siteid = '33589766';
var LR_isMobile = 0;
var LR_64899='8C0015651EC94DC99F69BDA933305A8B';LR_64899=((3+1).toString()+LR_64899+(3*1).toString());var LR_62152=LR_64899.replace(/1/g,'3').replace(/0/g,'2');var LiveReceptionCode_isonline = 1;
var LR_js_pm = 'd';
LR_62152=((4+3).toString()+LR_62152+(4*3).toString());var LR_JAMA=LR_62152.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&BMLA='+LR_JAMA;
